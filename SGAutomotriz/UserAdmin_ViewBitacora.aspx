<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserAdmin_ViewBitacora.aspx.cs" Inherits="SGAutomotriz.UserAdmin_ViewBitacora" %>
...
<head runat="server">
   ...
   <%-- <script type="text/javascript" src="js/jquery-ui-1.8.23.custom.min.js"></script>
    ...
    <script type="text/javascript">
        function showAlert() {
            alertify.success('Exito! al actualizar');
        }
        function showAlert2() {
...
<body>
                        ...
                        <li>
                         ...
                         <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <!-- son los logs de acciones en la BD -->
                                    <a href="#">Edición de asignación</a>
                                </li>
                                <%--<li>
                                    <a href="#">Third Level <span class="fa arrow"></span></a>
                                    <ul class="nav nav-third-level">
    ...
    <!---- Body ----------------------------------------------------------------------------->
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Detalle de bitácora</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <form id="form1" runat="server">
                                        <input class="form-control" id="idBitacora" type="text" runat="server" visible="false">
                                        <div class="form-group">
                                            <label>Cliente</label>
                                            <input class="form-control" id="cliente" type="text" runat="server" disabled>
                                        </div>
                                        <div class="form-group">
                                            <label>Vehiculo</label>
                                            <input class="form-control" id="vehiculo" type="text" runat="server" disabled>
                                        </div>
                                        <div class="form-group">
                                            <label>Fecha</label>
                                            <input class="form-control" id="fecha" type="text" runat="server" disabled>
                                        </div>
                                        <div class="form-group">
                                            <label>Servicio</label>
                                            <input class="form-control" id="servicio" type="text" runat="server" disabled>
                                        </div>
                                        <div class="form-group">
                                            <label>Actividad</label>
                                            <textarea class="form-control" id="descAct" runat="server" rows="5" disabled></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>Cantidad Facturada</label>
                                            <input class="form-control" id="cantidadFact" type="text" runat="server" disabled>
                                        </div>
                                        <asp:Button ID="return" CssClass="btn btn-primary" runat="server" Text="Regresar" OnClick="return_Click" />
