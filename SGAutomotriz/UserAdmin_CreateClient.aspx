<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserAdmin_CreateClient.aspx.cs" Inherits="SGAutomotriz.UserAdmin_CreateClient" %>
...
<body>
    ...
    <!---- Body ----------------------------------------------------------------------------->
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Alta de clientes</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
