<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserAdmin_DetailsBitacora.aspx.cs" Inherits="SGAutomotriz.UserAdmin_DetailsBitacora" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function showAlert() {
            alertify.warning('Ingresa fechas para la consulta');
        }
        function showAlert2() {
                ...
                <div class="col-lg-12">
                           <form id="form1" runat="server">
                             <div class="panel panel-info">
                                 <div class="panel-heading">Búsqueda por fechas</div>
                                <div class="panel-body">
                                <div class="form-group">
                                    <label>Fecha inicial</label>
                                        <input class="form-control" id="fechainicial" type="date" runat="server">
                                </div>
                               <div class="form-group">
                                    <label>Fecha final</label>
                                        <input class="form-control" id="fechafinal" type="date" runat="server">
                                </div>
                                 <asp:Button ID="save" CssClass="btn btn-primary" runat="server" Text="Buscar" OnClick="save_Click"   />
                                 <asp:Button ID="clean" CssClass="btn btn-default" runat="server" Text="Cancelar" OnClick="clean_Click" />
                            <br />
                            <br />
                               <asp:GridView ID="GridView1" DataKeyNames="idBitacora" runat="server" AutoGenerateColumns="False" 
                                   ...
                                   OnPageIndexChanging="GridView1_PageIndexChanging" PagerStyle-CssClass="pagination">
                                        <Columns>
                                            <asp:BoundField DataField="idBitacora" HeaderText="ID" Visible="false" />
                                            <asp:BoundField DataField="cliente" HeaderText="Cliente"/>
                                            <asp:BoundField DataField="vehiculo" HeaderText="Vehiculo" />
                                            <asp:BoundField DataField="fecha" HeaderText="Fecha"/>
                                            <asp:HyperLinkField DataNavigateUrlFields="idBitacora" DataNavigateUrlFormatString="UserAdmin_ViewBitacora.aspx?idBitacora={0}" ControlStyle-CssClass="fa-edit" HeaderText="Detalles">
