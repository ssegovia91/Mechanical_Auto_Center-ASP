<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserAdmin_CreateBitacora.aspx.cs" Inherits="SGAutomotriz.UserAdmin_CreateBitacora" %>
...
<body>
    ...
    <!---- Body ----------------------------------------------------------------------------->
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Alta de Bitácora</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                                ...
                                <div class="col-lg-6">
                                    <form id="form1" runat="server">
                                        <div class="form-group">
                                            ...
                                            <asp:DropDownList ID="nombreCliente" CssClass="form-control" runat="server" AutoPostBack="true" OnSelectedIndexChanged="nombreCliente_SelectedIndexChanged"></asp:DropDownList>
                                        </div>
                                        <div class="form-group">
                                            <label>Vehiculos Asociados</label>
                                            <asp:DropDownList ID="VehicAsoc" runat="server" CssClass="form-control"></asp:DropDownList>
                                        </div>
                                        <div class="form-group">
                                            <label>Fecha</label>
                                            <input class="form-control" id="fecha" type="date" runat="server" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Servicio</label>
                                            <input class="form-control" id="servicio" type="text" runat="server" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Descripción de actividad</label>
                                            <textarea class="form-control" id="DescAct" runat="server" rows="10"></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>Cantidad facturada</label>
                                            <input class="form-control" id="factura" type="text" runat="server">
                                        </div>
