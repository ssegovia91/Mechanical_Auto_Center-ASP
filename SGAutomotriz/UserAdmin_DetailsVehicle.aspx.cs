...
{
    public partial class UserAdmin_DetailsVehicle : System.Web.UI.Page
    {
        ...
        //            command.Parameters.Add("@idVehiculo", SqlDbType.VarChar).Value = empid;
        //            SqlDataAdapter adaptador = new SqlDataAdapter(command);
        //            DataSet ds = new DataSet();
        //            adaptador.Fill(ds);
        //            GridView1.DataSource = ds;
        ...
        protected void Button2_Click2(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (conn != null && string.IsNullOrEmpty(message))
                {
                    ...
                    command.Parameters.Add(new SqlParameter("@idVehiculo", SqlDbType.VarChar));
                    command.Parameters["@operacion"].Value = "Delete";
                    command.Parameters["@idVehiculo"].Value = idrow;
                    SqlDataAdapter adaptador = new SqlDataAdapter(command);
                    ds = new DataSet();
                    adaptador.Fill(ds);
