<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserSys_Create.aspx.cs" Inherits="SGAutomotriz.UserSys_Create" %>
...
<body>
    ...
    <!---- Body ----------------------------------------------------------------------------->
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Alta de usuarios</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <form id="form1" runat="server">
                                        ...
                                        <asp:Button ID="save" CssClass="btn btn-primary" runat="server" Text="Guardar" onclick="save_Click1" />
                                        <asp:Button ID="clean" CssClass="btn btn-default" runat="server" Text="Limpiar" onclick="clean_Click1" />
                                    </form>
                                </div>
                            </div>
                            <!-- /.row (nested) -->
