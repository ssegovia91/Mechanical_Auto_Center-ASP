<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserAdmin_EditClient.aspx.cs" Inherits="SGAutomotriz.UserAdmin_EditClient" %>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <form id="form1" runat="server">
                                        <input class="form-control" id="idClient" type="text" runat="server" visible="false">
                                        <div class="form-group">
                                            <label>Cliente</label>
                                            <input class="form-control" id="nombreCliente" type="text" runat="server" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Calle</label>
                                            <input class="form-control" id="calle" type="text" runat="server" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Colonia</label>
                                            <input class="form-control" id="colonia" type="text" runat="server" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Telefono Casa</label>
                                            <input class="form-control" id="telcasa" type="text" runat="server" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Telefono Celular</label>
                                            <input class="form-control" id="telcel" type="text" runat="server" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Notas</label>
                                            <textarea class="form-control" id="notas" runat="server" rows="3"></textarea>
                                        </div>
                                        <asp:Button ID="save" CssClass="btn btn-primary" runat="server" Text="Guardar" OnClick="save_Click"  />
                                        <asp:Button ID="cancel" CssClass="btn btn-default" runat="server" Text="Cancelar" OnClick="cancel_Click"  />
