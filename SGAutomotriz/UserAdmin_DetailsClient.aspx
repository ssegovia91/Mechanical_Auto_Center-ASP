<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserAdmin_DetailsClient.aspx.cs" Inherits="SGAutomotriz.UserAdmin_DetailsClient" %>
                               ...
                               <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                   <ContentTemplate>
                                       <asp:Timer ID="Timer1" runat="server" OnTick="Timer1_Tick" Interval="2000" ></asp:Timer>
                                           <asp:GridView ID="GridView1" DataKeyNames="idCliente" runat="server" AutoGenerateColumns="False"
                                               ...
                                               OnPageIndexChanging="GridView1_PageIndexChanging" PagerStyle-CssClass="pagination">
                                                    <Columns>
                                                        <asp:BoundField DataField="idCliente" HeaderText="ID" Visible="false" />
                                                        <asp:BoundField DataField="nombreCliente" HeaderText="Cliente"/>
                                                        <asp:BoundField DataField="calle" HeaderText="Calle" />
                                                        <asp:BoundField DataField="colonia" HeaderText="Colonia"/>
                                                        <asp:BoundField DataField="telcel" HeaderText="Tel. Casa"/>
                                                        <asp:BoundField DataField="telcasa" HeaderText="Celular"/>
                                                        <asp:BoundField DataField="notas" HeaderText="Notas" />
                                                        <asp:HyperLinkField DataNavigateUrlFields="idCliente" DataNavigateUrlFormatString="UserAdmin_EditClient.aspx?idCliente={0}" ControlStyle-CssClass="fa-edit" HeaderText="Edici&oacute;n">
