<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserAdmin_CreateClientVehicle.aspx.cs" Inherits="SGAutomotriz.UserAdmin_CreateClientVehicle" %>
...
<body>
    ...
    <!---- Body ----------------------------------------------------------------------------->
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Asignación Cliente - Vehiculo</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                                ...
                                <div class="col-lg-6">
                                    <form id="form1" runat="server">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="cliente" runat="server"></select>
                                        </div>
                                        <div class="form-group">
                                            <label>Selecciona los vehiculos asociados</label>
                                            <select multiple class="form-control" id="vehiculos" runat="server"></select>
                                        </div>
