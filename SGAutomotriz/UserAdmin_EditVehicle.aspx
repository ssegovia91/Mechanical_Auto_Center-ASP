<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserAdmin_EditVehicle.aspx.cs" Inherits="SGAutomotriz.UserAdmin_EditVehicle" %>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <form id="form1" runat="server">
                                        <input class="form-control" id="idVehicle" type="text" runat="server" visible="false">
