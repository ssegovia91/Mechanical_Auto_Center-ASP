<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserAdmin_Home.aspx.cs" Inherits="SGAutomotriz.UserAdmin_Home" %>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="jumbotron">
                        <h1>Bienvenido!!</h1>
                        <p>
                            El Sistema de Gestión Automotriz Solis nace a partir de la necesidad de administrar la información que día a día se genera
                            en las jornadas laborales de este negocio, permitiendo agendar los clientes del taller y relacionar los vehiculos propietarios, 
                            con la finalidad de llevar un control de actividades diarias a través de las bitacoras de trabajo.  
                        </p>
                    </div>
                </div>
                <!-- /.col-lg-12 -->
